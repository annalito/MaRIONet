...
\begin{minipage}{0.40\textwidth}
  ...
  \begin{center}
     \includegraphics[width=5cm]{MaRIONet/marionet_logo.png}
      \Large
      \textsf{Season's Greetings from MaRIONet\\}

      \textsf{We would be delighted to see you at the next MaRIONet workshop\\ (Jan 24, Manchester)\\ and\\ our PhD Summer School\\ (Jul 16-20, Glasgow).} 
